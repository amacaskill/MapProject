...
public final class RatTerm {
  ...
  public boolean isZero() {
	  return this.equals(RatTerm.ZERO);
  }
  ...
  public RatTerm differentiate() {
	  if (this.isNaN()) {
		  ...
		  RatNum temp = new RatNum(this.expt);
		  return new RatTerm(this.coeff.mul(temp), this.expt - 1);
	  }
  }
  ...
  public RatTerm antiDifferentiate() {
	  if (this.isNaN()) {
		  ...
		  RatNum temp = new RatNum(this.expt + 1);
		  return new RatTerm(this.coeff.div(temp), this.expt + 1);
	  }
  }
